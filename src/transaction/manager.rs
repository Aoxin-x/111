...
mod tests {
    ...
    fn test_transaction_begin() {
        ...
        let file_path = temp_dir().join("tm_test_begin.log");
    ...
    fn test_transaction_commit() {
        use std::env::temp_dir;
        let file_path = temp_dir().join("tm_test_commit.log");
        let path = file_path.to_str().unwrap();
        std::fs::remove_file(path).ok();
    ...
    fn test_transaction_rollback() {
        use std::env::temp_dir;
        let file_path = temp_dir().join("tm_test_rollback.log");
        let path = file_path.to_str().unwrap();
        std::fs::remove_file(path).ok();
    ...
    fn test_transaction_manager() {
        use std::env::temp_dir;
        let file_path = temp_dir().join("test_tx.log");
        let path = file_path.to_str().unwrap();
        std::fs::remove_file(path).ok();
